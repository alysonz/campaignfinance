...
cursor.execute("select * from names where (entityTypeName = 'Business' or entityTypeName = 'Individual') and lastName like 'aarons' and firstName like 'barry';")
#fetch results
...
cursor.execute("select * from names where nameID = 1196220;")
#turn that information into a list
committeeName = gettuple(cursor.fetchall())
print "check1"
